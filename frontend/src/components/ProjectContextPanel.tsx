const missionPoints = [
	{
		title: "Energy impact",
		detail: "Reduce pumping spend without pushing tunnel level outside 0.5–8.0 m safety band.",
	},
	{
		title: "Evidence-first decisions",
		detail: "Blend weather, inflow, price, and physics agents so each recommendation ships with traceable context.",
	},
	{
		title: "Human control",
		detail: "Manual overrides, justifications, and audit trails remain first-class to maintain operator trust.",
	},
];
...
const stack = [
	...
	{
		label: "Agents",
		detail: "Weather, price, inflow, status, and optimizer services exposed over MCP",
	},
];
