    ...
    <div className="glass-card space-y-5">
      ...
      <div>
        ...
        <ul className="mt-2 space-y-3 text-sm text-slate-200">
          {missionPoints.map((point) => (
            <li
              key={point.title}
              className="rounded-2xl border border-white/5 bg-white/5 px-3 py-2 transition-all duration-300 hover:-translate-y-0.5 hover:border-white/20 hover:bg-white/10 hover:shadow-[0_6px_16px_rgba(15,23,42,0.35)]"
            >
      ...
      <div>
        ...
        <div className="mt-2 space-y-3">
          {stack.map((item) => (
            <div
              key={item.label}
              className="rounded-2xl border border-white/5 bg-slate-900/60 px-3 py-2 transition-all duration-300 hover:-translate-y-0.5 hover:border-white/10 hover:bg-slate-900/80 hover:shadow-[0_8px_20px_rgba(15,23,42,0.45)]"
            >
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {metrics.map((metric) => (
          <div
            key={metric.label}
            className="rounded-2xl border border-brand-accent/10 bg-gradient-to-br from-brand-accent/5 to-brand-accent/10 px-3 py-2 transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-accent/30 hover:shadow-[0_10px_24px_rgba(56,189,248,0.35)]"
          >
