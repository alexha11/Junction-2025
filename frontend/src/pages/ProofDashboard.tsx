  ...
  <div className="space-y-6">
    <header className="glass-card space-y-3">
      ...
      <p className="text-slate-300">
        Track delivery evidence across documentation, simulations, and QA runs.
        This view doubles as a stakeholder-friendly roll-up that highlights
        progress, risks, and next actions for the AI agent stack.
      </p>
    </header>
